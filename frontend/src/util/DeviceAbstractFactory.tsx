...
=======
  ...
  constructor(
    settings: MusicSettings,
    debugOptionObject: TDebugOptionsObject,
    handler: any,
    enhancer: any
  ) {
    this.debugOutput = debugOptionObject.debugOption1;
    ...
    this.noteHandler = new handler.NoteHandler(
      this.settings,
      debugOptionObject
    );
  ...
  public recordInputStream() {
    ...
    if (this.debugOutput) {
      console.log("DeviceRawStream:", currentData);
    }
...
export class ConcreteCytonStream implements AbstractCytonStream {
  ...
  public recordInputStream(data: any) {
    ...
    if (this.debugOutput) {
      console.log("DeviceStream:", currentData);
    }
