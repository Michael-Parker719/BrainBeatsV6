import {
  ...
  ConcreteCytonStream,
  ConcreteGanglionStream,
  ConcreteTestStream,
} from "../../util/DeviceAbstractFactory";
...
import V6algorithmNames from "../../util/MusicGeneration/Algorithms/V6names.json";
...
function Record() {
  ...
  const V6algorithms = V6algorithmNames.algorithmNames;
  ...
  async function doRecording() {
    ...
    let NoteHandler = await import(
      "../../util/MusicGeneration/Algorithms/" + genOption + "/NoteGeneration"
    );

    let V6NoteHandler = await import(
      ...
      <div id="record-container-body">
        ...
        <div id="record-btns-div">
            ...
            <div className="devBox">
              ...
              <div className="form-check">
                <input
                  ...
                  value="3"
                  id="flexCheckDefault"
                  checked={debugOption3}
                  onClick={() => handleForm(3)}
                />
                <label className="form-check-label" htmlFor="flexCheckDefault">
          ...
          <div className="setupGuide">
            ...
            <p>
              If you need to understand how to get started, view our setup guide{" "}
              <Link to="/setup" target="_blank">
                here.
              </Link>
              <br />
              Otherwise, continue by hitting the record button below:
            </p>
            ...
            <select
              ...
              value={genOption}
              id="genselect"
              onChange={(e) => setGenOption(e.target.value)}
            >
              {deviceName === "arduino-uno"
                ? // V6 algorithm only available for Arduino Uno
                  V6algorithms.map((option, index) => (
                    <option key={index} value={option}>
                      {option}
                    </option>
                  ))
                : // Otherwise, map through the algorithms array
