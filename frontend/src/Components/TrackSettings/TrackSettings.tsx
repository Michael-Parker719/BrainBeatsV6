  ...
  return (
    <>
      {instrumentArray.map((instrument) => (
        <option key={instrument.name} value={instrument.value}>
          {instrument.name}
        </option>
      ))}
    </>
  ...
  return (
    <>
      {noteArray.map((noteDuration) => (
        <option key={noteDuration.name} value={noteDuration.value}>
          {noteDuration.name}
        </option>
      ))}
    </>
...
const TrackSettings = () => {
  const settings = useAppSelector(
    (state) => state.musicGenerationSettingsSlice
  );
  ...
  return (
    <div className="container" id="main-container">
      ...
      <div id="track-settings-container">
        <div
          id="settings1"
          style={{ display: advSettingsOpen ? "none" : "block" }}
        >
          <form className="justify-content-center" id="settings-container1">
            ...
            <div id="select-device-div">
              <h6 className="centered-text" id="centered-text">
              ...
              >
                ...
                {isDev() && (
                  <option value="random data">(Dev) Random Data</option>
                )}
              </select>
            </div>
          ...
          <form className="justify-content-center" id="settings-container2">
            ...
            <p className="centered-text">
              Press the button below to go to advanced music generation
              settings:
            </p>
        ...
        <div
          id="settings2"
          style={{ display: advSettingsOpen ? "block" : "none" }}
        >
          ...
          <form className="justify-content-center adv-settings-container">
            ...
            <button
              ...
              id="random-btn-adv"
              onClick={getRandomMusicSettings}
            >
              Randomize!
            </button>
            <div className="row instruments-div">
              <div className="col instrument-box">
                ...
                <select
                  className="dropdowns"
                  name="instrument1"
                  id="instrument1-options"
                  value={instrument00}
                  defaultValue={instrument00}
                  onChange={(e) => {
                    setInstrument00(Number(e.target.value));
                  }}
                >
                  <InstrumentSettings />
                </select>
                <br></br>
                <label htmlFor="instrument1-note">
                  Instrument 1 Note Type:
                </label>
                <select
                  className="dropdowns"
                  name="instrument1-note"
                  id="instrument1-notes"
                  value={duration00}
                  defaultValue={duration00}
                  onChange={(e) => {
                    setDuration00(Number(e.target.value));
                  }}
                >
                  <NoteSettings />
                </select>
              ...
              <div className="col instrument-box">
                ...
                <select
                  className="dropdowns"
                  name="instrument2"
                  id="instrument2-options"
                  value={instrument01}
                  defaultValue={instrument01}
                  onChange={(e) => {
                    setInstrument01(Number(e.target.value));
                  }}
                >
                  <InstrumentSettings />
                </select>
                <br></br>
                <label htmlFor="instrument2-note">
                  Instrument 2 Note Type:
                </label>
                <select
                  className="dropdowns"
                  name="instrument2-note"
                  id="instrument2-notes"
                  value={duration01}
                  defaultValue={duration01}
                  onChange={(e) => {
                    setDuration01(Number(e.target.value));
                  }}
                >
                  <NoteSettings />
                </select>
              ...
              <div className="col instrument-box">
                ...
                <select
                  className="dropdowns"
                  name="instrument3"
                  id="instrument3-options"
                  value={instrument02}
                  defaultValue={instrument02}
                  onChange={(e) => {
                    setInstrument02(Number(e.target.value));
                  }}
                >
                  <InstrumentSettings />
                </select>
                <br></br>
                <label htmlFor="instrument3-note">
                  Instrument 3 Note Type:
                </label>
                <select
                  className="dropdowns"
                  name="instrument3-note"
                  id="instrument3-notes"
                  value={duration02}
                  defaultValue={duration02}
                  onChange={(e) => {
                    setDuration02(Number(e.target.value));
                  }}
                >
                  <NoteSettings />
                </select>
              ...
              <div className="col instrument-box">
                ...
                <select
                  className="dropdowns"
                  name="instrument4"
                  id="instrument4-options"
                  value={instrument03}
                  defaultValue={instrument03}
                  onChange={(e) => {
                    setInstrument03(Number(e.target.value));
                  }}
                >
                  <InstrumentSettings />
                </select>
                <br></br>
                <label htmlFor="instrument4-note">
                  Instrument 4 Note Type:
                </label>
                <select
                  className="dropdowns"
                  name="instrument4-note"
                  id="instrument4-notes"
                  value={duration03}
                  defaultValue={duration03}
                  onChange={(e) => {
                    setDuration03(Number(e.target.value));
                  }}
                >
                  <NoteSettings />
                </select>
                ...
                <>
                  <div className="col instrument-box">
                    ...
                    <select
                      className="dropdowns"
                      name="instrument5"
                      id="instrument5-options"
                      value={instrument04}
                      defaultValue={instrument04}
                      onChange={(e) => {
                        setInstrument04(Number(e.target.value));
                      }}
                    >
                      <InstrumentSettings />
                    </select>
                    <br></br>
                    <label htmlFor="instrument5-note">
                      Instrument 5 Note Type:
                    </label>
                    <select
                      className="dropdowns"
                      name="instrument5-note"
                      id="instrument5-notes"
                      value={duration04}
                      defaultValue={duration04}
                      onChange={(e) => {
                        setDuration04(Number(e.target.value));
                      }}
                    >
                      <NoteSettings />
                    </select>
                  ...
                  <div className="col instrument-box">
                    ...
                    <select
                      className="dropdowns"
                      name="instrument6"
                      id="instrument6-options"
                      value={instrument05}
                      defaultValue={instrument05}
                      onChange={(e) => {
                        setInstrument05(Number(e.target.value));
                      }}
                    >
                      <InstrumentSettings />
                    </select>
                    <br></br>
                    <label htmlFor="instrument6-note">
                      Instrument 6 Note Type:
                    </label>

                    <select
                      className="dropdowns"
                      name="instrument6-note"
                      id="instrument6-notes"
                      value={duration05}
                      defaultValue={duration05}
                      onChange={(e) => {
                        setDuration05(Number(e.target.value));
                      }}
                    >
                      <NoteSettings />
                    </select>
                  ...
                  <div className="col instrument-box">
                    ...
                    <select
                      className="dropdowns"
                      name="instrument7"
                      id="instrument7-options"
                      value={instrument06}
                      defaultValue={instrument06}
                      onChange={(e) => {
                        setInstrument06(Number(e.target.value));
                      }}
                    >
                      <InstrumentSettings />
                    </select>
                    ...
                    <br></br>
                    <label htmlFor="instrument7-note">
                      Instrument 7 Note Type:
                    </label>

                    <select
                      className="dropdowns"
                      name="instrument7-note"
                      id="instrument7-notes"
                      value={duration06}
                      defaultValue={duration06}
                      onChange={(e) => {
                        setDuration06(Number(e.target.value));
                      }}
                    >
                      <NoteSettings />
                    </select>
                  ...
                  <div className="col instrument-box">
                    ...
                    <select
                      className="dropdowns"
                      name="instrument8"
                      id="instrument8-options"
                      value={instrument07}
                      defaultValue={instrument07}
                      onChange={(e) => {
                        setInstrument07(Number(e.target.value));
                      }}
                    >
                      <InstrumentSettings />
                    </select>
                    <br></br>
                    <label htmlFor="instrumeny8-note">
                      Instrument 8 Note Type:
                    </label>
                    <select
                      className="dropdowns"
                      name="instrument8-note"
                      id="instrument8-notes"
                      value={duration07}
                      defaultValue={duration07}
                      onChange={(e) => {
                        setDuration07(Number(e.target.value));
                      }}
                    >
                      <NoteSettings />
                    </select>
            ...
            <div className="row instruments-other-div">
              ...
              <div className="col instrument-box-other">
                ...
                <select
                  className="dropdowns2"
                  name="key-signature"
                  id="key-signature-option"
                  value={keyGroup}
                  defaultValue={keyGroup}
                  onChange={(e) => setKeyGroup(e.target.value)}
                >
        ...
        <div>
          ...
          <div>
            ...
            <input
              ...
              id="formGroupExampleInput"
              placeholder="Title"
              onChange={(event) => setLikes(event.target.valueAsNumber)}
            />
          </div>
